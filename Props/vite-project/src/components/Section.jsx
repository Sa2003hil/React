    ...
    return (
        <div className="h-screen w-screen overflow-hidden mt-6 relative">
            <div className="absolute h-full w-full left-20 top-0">
                ...
                <div className="text-white absolute top-0 left-0 flex items-center justify-start h-full w-full">
                    <div className="h-full gap-12 flex items-start justify-center flex-col pl-24">
                        ...
                        <div className="flex items-center justify-center gap-6 text-sm">
                            <div className="bg-[#5D50C6] rounded-full py-4 px-6 text-white">
                                Get Started
                            </div>
                            <div className="bg-white rounded-full py-4 px-6 text-black">
                                Watch Demo
                            </div>
                        </div>
                    </div>
